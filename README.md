...
infer.make_image(model_path="x2AnimeFinal_gzku.safetensors",
...
infer = fesd(device='cuda',use_fp16=False,mode="SD",img2img=True)

infer.make_image(model_path="milkyWonderland_v20.safetensors",
...
cpu_onnx_infer = fesd(device='cpu',use_fp16=False,mode="ONNX",img2img=True)
...
infer_result = infer.make(model_path="milkyWonderland_v20.safetensors",
                ...
                n_prompt="bad hand,text,watermark,low quality,medium quality,blurry,censored,wrinkles,deformed,mutated text,watermark,low quality,medium quality,blurry,censored,wrinkles,deformed,mutated",
                seed=0,steps=8,cfg=2,height=512,width=512,prompt_strength=0.4,num_images=1)
